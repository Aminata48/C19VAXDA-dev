        ...
        methods: {
            ...
            selectScenarioFile() {
                ...
                if (language === "en" && voice === "female")
                    this.scenario.push(require("../../assets/jsonFromHerdimm/scenario_female_en.json"));
                else if (language === "fr" && voice === "female")
                    this.scenario.push(require("../../assets/jsonFromHerdimm/scenario_female_fr.json"));
                else if (language === "en" && voice === "male")
                    this.scenario.push(require("../../assets/jsonFromHerdimm/scenario_male_en.json"));
                else if (language === "fr" && voice === "male")
                    this.scenario.push(require("../../assets/jsonFromHerdimm/scenario_male_fr.json"));
                else {
                    this.scenario.push(require("../../assets/jsonFromHerdimm/scenario_female_en.json"));
                }
            }
