...
<script>
    import Character from "../components/AvatarsFromHerdimm/Character";
    import AudioPlayer from "../components/AvatarsFromHerdimm/AudioPlayer";
    // The scenario might need to be imported in AudioPlayer instead of here, I'm not sure at the moment
    import shapesArray from "../assets/jsonFromHerdimm/shapesArray";
    import textsEng from "../assets/jsonFromHerdimm/textsEng.json";
    import textsFr from "../assets/jsonFromHerdimm/textsFr.json";
    import connections from "../assets/jsonFromHerdimm/connections.json";
    ...
    export default {
        ...
        methods: {
            ...
            parseSpreadInfection(props){
                ...
                if (typeof(props.file) === "object") {
                    if (localStorage.getItem("disease") === this.diseaseArray[0] || localStorage.getItem("disease") === this.diseaseArray[1] || localStorage.getItem("disease") === this.diseaseArray[2])
                    {
                        ...
                        path = require("../assets/jsonFromHerdimm/" + localStorage.getItem("disease")+".json");
                        setTimeout(() => {
                        ...
                        if (props.file.length !== 0) {
                            ...
                            path = require("../assets/jsonFromHerdimm/" + props.file[value]);
                            setTimeout(() => {
                                this.spreadInfection(path.connections, durationLine, durationLineBouncingOff, linewidth);
                            }, props.startTime);
                        } else {
                    ...
                    path = require("../assets/jsonFromHerdimm/" + props.file);
            ...
            vaccination(props){
                const selector = '#main-container #';
                let value = 0;
                let file = require("../assets/jsonFromHerdimm/" + props.file);
