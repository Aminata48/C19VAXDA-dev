...
<script>
import CharacterList from "../components/AvatarsFromHerdimm/CharacterList";
import GroupCharacter from "../components/AvatarsFromHerdimm/GroupCharacter";
import Modal from "../components/AvatarsFromHerdimm/Modal";

import charactersJson from "../assets/jsonFromHerdimm/characters.json";
import textsEng from "../assets/jsonFromHerdimm/textsEng.json";
import textsFr from "../assets/jsonFromHerdimm/textsFr.json";
import facialHairJson from "../assets/jsonFromHerdimm/facialHair.json";
...
export default {
  ...
  mounted() {
    ...
    this.disableRandomBtn();
    this.$emit('changeRouteName', "AutoGenerated");
